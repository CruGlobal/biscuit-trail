...
export const TranslationText: { [key in Translations]: { [key2 in TranslationTextKey]: string } } = {
  ...
  [Translations.it]: {
    ...
    shareJoin: 'Unisciti a me su scatola dei biscotti! Codice:',
  ...
  [Translations.es]: {
    ...
    shareJoin: '¡Únete a mí en Rastro de las Galletas! Código:',
  ...
  [Translations.ar]: {
    ...
    shareJoin: 'انضم إلي على Biscuit Trail! الشفرة:',
